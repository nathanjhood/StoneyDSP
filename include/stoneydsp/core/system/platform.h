...
#pragma once
   ...
   * - Either STONEYDSP_32BIT or STONEYDSP_64BIT, depending on the
   * architecture.
...
//==============================================================================
    ...
    #if defined(_M_ARM) || defined(_M_ARM64) || defined(__arm__)              \
        || defined(__aarch64__)
...
//==============================================================================
      ...
      #define STONEYDSP_INTEL 1
        ...
        #error                                                                \
            "The 10.14 SDK (Xcode 10.1+) is required to build STONEYDSP apps. You can create apps that run on macOS 10.9+ by changing the deployment target."
