...
function(stoneydsp_add_catch2_session)
    ...
    set(STONEYDSP_TEST_CATCH2_SESSION_CPP_FILE "${STONEYDSP_TEST_DIR}/catch2session.cpp")
    ...
    foreach(STONEYDSP_TEST_CATCH2_SESSION_HEADER_FILE IN LISTS STONEYDSP_TEST_CATCH2_SESSION_HEADER_FILES)
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - adding header: ${STONEYDSP_TEST_CATCH2_SESSION_HEADER_FILE}")
        ...
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - added header: ${STONEYDSP_TEST_CATCH2_SESSION_HEADER_FILE}")
    ...
    foreach(STONEYDSP_TEST_CATCH2_SESSION_SOURCE_FILE IN LISTS STONEYDSP_TEST_CATCH2_SESSION_SOURCE_FILES)
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - adding source: ${STONEYDSP_TEST_CATCH2_SESSION_SOURCE_FILE}")
        target_sources(${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME}
            PRIVATE
            "${STONEYDSP_TEST_CATCH2_SESSION_SOURCE_FILE}"
        )
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - added source: ${STONEYDSP_TEST_CATCH2_SESSION_SOURCE_FILE}")
    ...
    foreach(STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY IN LISTS STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARIES_PRIVATE)
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - linking library (private): ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}")
        target_link_libraries(${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME}
            PRIVATE
            ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}
        )
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - linked library (private): ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}")
    ...
    foreach(STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY IN LISTS STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARIES_PUBLIC)
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - linking library (public): ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}")
        target_link_libraries(${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME}
            PUBLIC
            ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}
        )
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - linked library (public): ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}")
    ...
    foreach(STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY IN LISTS STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARIES_INTERFACE)
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - linking library (interface): ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}")
        target_link_libraries(${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME}
            INTERFACE
            ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}
        )
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - linked library (interface): ${STONEYDSP_TEST_CATCH2_SESSION_LINK_LIBRARY}")
    ...
    foreach(STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION IN LISTS STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITIONS_PRIVATE)
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - adding compile definiton (private): ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}")
        target_compile_definitions(${SSTONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME}
            PRIVATE
            ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}
        )
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - added compile definiton (private): ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}")
    ...
    foreach(STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION IN LISTS STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITIONS_PUBLIC)
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - adding compile definiton (public): ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}")
        target_compile_definitions(${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME}
            PUBLIC
            ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}
        )
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - added compile definiton (public): ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}")
    ...
    foreach(STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION IN LISTS STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITIONS_INTERFACE)
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - adding compile definiton (interface): ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}")
        target_compile_definitions(${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME}
            INTERFACE
            ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}
        )
        message(STATUS "Target: ${STONEYDSP_TEST_CATCH2_SESSION_TARGET_NAME} - added compile definiton (interface): ${STONEYDSP_TEST_CATCH2_SESSION_COMPILE_DEFINITION}")
...
function(stoneydsp_add_test)
    ...
    # Set files
    set(STONEYDSP_TEST_MAIN_CPP_FILE "${STONEYDSP_TEST_DIR}/main.cpp")
