...
ASM_CC_COMPILER_LAUNCHER := $(ASM_CC_COMPILER) -S $(ASMFLAGS) -std=$(C_DIALECT)$(C_STANDARD)
ASM_CXX_COMPILER_LAUNCHER := $(ASM_CXX_COMPILER) -S $(ASMFLAGS) -std=$(CXX_DIALECT)$(CXX_STANDARD)
